...
if(isset($_POST['update_post']))
{
	...
	move_uploaded_file($post_image_temp, "admin_includes/move_uploaded_images/$post_image");
...
?>
	...
	<div class="form-group">
		...
		<input value="<?php echo $post_author; ?>"  type="text" 
		name="post_author" class="form-control">
	</div>
	...
	<div class="form-group">
		<img width='100' src="admin_includes/move_uploaded_images/<?php echo $post_image; ?>" 
		alt=''>
	...
	<div class="form-group">
		...
		<input value="<?php echo $post_tags; ?>" type="text"
